...
- **8-Point Grid System (Strict Spacing, Sizing & Asset Scale)**:
  - All layout spacing (`padding`, `margin`, `gap`), component dimensions, and asset containers **MUST** strictly adhere to the **8-Point Grid Scale** (or `4px` half-step for micro badges/tags):
    - `4px` (0.5x), `8px` (1x base), `12px` (1.5x), `16px` (2x), `24px` (3x), `32px` (4x), `40px` (5x), `48px` (6x), `56px` (7x), `64px` (8x).
  ...
  - **Calendar Heatmap Matrix & Datepicker**:
    - Desktop Day Cells: `min-height: 64px` ($8 \times 8\text{px}$), `padding: 8px`, `border-radius: 8px`, grid `gap: 8px`.
    - Mobile Day Cells: `min-height: 48px` ($6 \times 8\text{px}$), `padding: 4px`, `border-radius: 6px`, grid `gap: 4px`.

...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        <?php if ($role === 'admin'): ?>
            ...
            <!-- PERUBAHAN: Menu Manajemen dijadikan top-level -->
        ...
        <?php elseif ($role === 'manajemen'): ?>
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?= $isKinerjaActive ? 'show' : '' ?>" id="kinerjaSubmenu">
                    <ul class="nav flex-column ps-4">
                        <li class="nav-item"><a href="<?= site_url('user/rencana/input') ?>" class="nav-link sub-link ...">Input Rencana Kerja</a></li>
                        <li class="nav-item"><a href="<?= site_url('user/realisasi/input') ?>" class="nav-link sub-link ...">Input Realisasi</a></li>
                        <li class="nav-item"><a href="<?= site_url('user/kinerja/update') ?>" class="nav-link sub-link ...">Kelola Target & Realisasi</a></li>
                    </ul>
                </div>
            </li>
        ...
        <?php else: // Menu untuk AAK dan KUK 
        ?>
            <!-- ================= MENU UNTUK AAK & KUK ================= -->

        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/master-data/led/update/' . $item['id']) ?>" method="POST" class="editForm form-simpan-scroll">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <!-- PERBAIKAN: name="id_standar", id="...", for="..." -->
                            ...
                            <select name="id_standar" id="edit_id_standar_<?= $item['id'] ?>" class="form-select">
                                ...
                                <?php if (!empty($standar_list)): ?> <?php foreach($standar_list as $standar): ?> 
                                    ...
                                    <!-- PERBAIKAN: $item['id_standar'] -->
                                    <option value="<?= esc($standar['id']) ?>" <?= (old('id_standar', $item['id_standar'] ?? null) == $standar['id']) ? 'selected' : '' ?>>

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <p class="text-muted mb-0">Kelola akun dan peran pengguna yang dapat mengakses sistem.</p>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        if ($role === 'spm') $badge_class = 'bg-dark'; // BARU
                                        if ($role === 'kabag_aak' || $role === 'kabag_kuk') $badge_class = 'bg-warning text-dark';
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" class="form-select <?= (isset($validation) && $validation->hasError('role')) ? 'is-invalid' : '' ?>" required>
                            ...
                            <option value="manajemen" <?= (old('role') == 'manajemen') ? 'selected' : '' ?>>Manajemen (Wadir)</option>
                            <option value="spm" <?= (old('role') == 'spm') ? 'selected' : '' ?>>SPM</option> <!-- BARU -->
                            <option value="kabag_aak" <?= (old('role') == 'kabag_aak') ? 'selected' : '' ?>>Kabag AAK</option>
                            <option value="kabag_kuk" <?= (old('role') == 'kabag_kuk') ? 'selected' : '' ?>>Kabag KUK</option>
...
<!-- ========================================================== -->
<!-- MODAL UNTUK EDIT PENGGUNA (PER USER) -->
<!-- ========================================================== -->
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" class="form-select" required>
                            ...
                            <option value="manajemen" <?= (old('role', $user['role']) == 'manajemen') ? 'selected' : '' ?>>Manajemen (Wadir)</option>
                            <option value="spm" <?= (old('role', $user['role']) == 'spm') ? 'selected' : '' ?>>SPM</option> <!-- BARU -->
                            <option value="kabag_aak" <?= (old('role', $user['role']) == 'kabag_aak') ? 'selected' : '' ?>>Kabag AAK</option>
                            <option value="kabag_kuk" <?= (old('role', $user['role']) == 'kabag_kuk') ? 'selected' : '' ?>>Kabag KUK</option>
...
document.addEventListener('DOMContentLoaded', function() {
    // (JavaScript untuk modal error dan toggle password)

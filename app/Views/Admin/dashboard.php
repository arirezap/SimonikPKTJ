                ...
                options: {
                    ...
                    scales: {
                        r: {
                            ...
                            suggestedMax: 100,
                            // ==================================================
                            // PERUBAHAN DI SINI (GRID & TICKS)
                            // ==================================================
                            grid: {
                                color: 'rgba(0, 0, 0, 0.1)', // Warna garis grid (abu-abu transparan)
                            },
                            pointLabels: { 
                                display: true, 
                                color: '#0d6efd', 
                            ...
                            ticks: { 
                                display: false, // Sembunyikan angka label sumbu
                                stepSize: 25,   // Jarak antar garis (100 dibagi 4 = 25)
                                maxTicksLimit: 5 // Batasi maksimal 5 tick (0, 25, 50, 75, 100)
                            }
                            // ==================================================
                        }
                    },
